  ...
  return (
    <div className="w-full self-center lg:w-1/2 ">
      ...
      <a
        ...
        className="text-base bg-primary justify-center w-56 flex font-semibold text-white py-3 px-8 rounded-full hover:shadow-lg hover:text-dark hover:opacity-80 transition duration-300 ease-in-out group"
      >
        <p> Hubungi Saya</p>
